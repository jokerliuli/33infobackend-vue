<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model.trim="picture.pictureTitle" clearable placeholder="图片标题" style="width: 200px;" class="filter-item" />
        ...
        <el-form-item label="Url" prop="pictureUrl">
          <el-upload
            ...
            <div slot="tip" class="el-upload__tip">
              <img :src="temp.pictureUrl" width="100%">
            </div>
...
import { remove, page, update, save } from '@/api/carousel'
