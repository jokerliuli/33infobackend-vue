...
export const constantRouterMap = [
  ...
  },
  {
    path: '/test',
    component: Layout,
    redirect: '/test/informationTest',
    meta: { title: '模块测试', icon: 'form' },
    children: [
      {
        path: 'informationTest',
        name: 'InformationTest',
        component: () => import('@/views/test/informationTest'),
        meta: { title: '资讯模块测试', icon: 'form' }
      },
      {
        path: 'leavemesTest',
        name: 'LeavemesTest',
        component: () => import('@/views/test/leavemesTest'),
        meta: { title: '留言模块测试', icon: 'form' }
      }
    ]
  },
  // {
